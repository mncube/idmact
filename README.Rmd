...
The higher value for Form A suggests that if each student were to answer one
additional item correctly, the mean scale score for Form A would increase more
than that of Form B.
